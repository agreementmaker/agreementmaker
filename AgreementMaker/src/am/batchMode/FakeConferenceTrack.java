...
public class FakeConferenceTrack extends Track {
	...
	public final static String TRACK_DIR = "conferenceFake";
	...
	public FakeConferenceTrack(String directory) {
		super();
	...
	public void execute() throws Exception {
		...
		matcherList = computeMultipleAlignment(ontologyFiles, GlobalStaticVariables.LANG_OWL, GlobalStaticVariables.SYNTAX_RDFXML, true, matcher, threshold, sourceCardinality, targetCardinality, param);
