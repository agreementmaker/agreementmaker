...
public class AnatomyTrack extends Track{
	...
	protected void execute() throws Exception{
		...
		if(doAll||subTrack.equals(TRACK_1)){
			...
			Alignment as = computeAlignment(SOURCE_ONTOLOGY, TARGET_ONTOLOGY, GlobalStaticVariables.LANG_OWL, GlobalStaticVariables.SYNTAX_RDFXML, false, matcher, threshold, sourceCardinality, targetCardinality, param);
