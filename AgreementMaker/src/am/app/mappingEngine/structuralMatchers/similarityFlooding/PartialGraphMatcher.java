...
//			if( round == 1 )System.out.println("----------- PHASE:" + round + ".0" + " ---------------");
			pairTable = new HashMap<String, PCGVertex>(); edgesMap = new HashMap<String, PCGEdge>();
			cOldVect = new Vector<Double>(); cNewVect = new Vector<Double>();
