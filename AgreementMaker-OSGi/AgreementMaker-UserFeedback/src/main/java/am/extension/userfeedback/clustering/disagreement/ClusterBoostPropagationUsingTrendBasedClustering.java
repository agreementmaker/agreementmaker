...
public class ClusterBoostPropagationUsingTrendBasedClustering extends
		ClusterBoostPropagation {
	@Override
	public void propagate(UFLExperiment experiment) {
		...
		LocalByTrendMethod clusteringMethod = new LocalByTrendMethod(
				availableMatchers);
