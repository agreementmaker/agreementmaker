...
public class ClusterFactoryDialog extends JDialog implements ActionListener {
	...
	private List<MatcherResult> matchers;
	...
	public ClusterFactoryDialog( ClusteringMethod method ) {
		...
		for( int i = 0; i < matchers.size(); i++ ) {
			MatcherResult currentMatcher = matchers.get(i);
			JCheckBox chkMatcher = new JCheckBox(currentMatcher.getMatchingTask().getShortLabel());
